...
class UtilisateursRepository extends ServiceEntityRepository
{
    ...
    public function transform(Utilisateurs $utilisateur)
    {
        return [
            'id'    => (int) $utilisateur->getId(),
            'nom' => (string) $utilisateur->getNom(),
            'role' => (string) $utilisateur->getRole(),
            'profession' => (string) $utilisateur->getProfession(),
            'division' => (string) $utilisateur->getDivision(),
            'email' => (string) $utilisateur->getEmail(),
            'login' => (string) $utilisateur->getLogin(),
            'token' => (string) $utilisateur->getToken()
        ];
    }
    ...
    public function transformAll()
    {
        ...
        foreach ($utilisateurs as $utilisateur) {
            $utilisateursArray[] = $this->transform($utilisateur);
        }
